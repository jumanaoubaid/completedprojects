...
private:
  ...
  void rotateRight();      //right rotation helper function
  void rotateLeft();       //left rotation helper function.
  TreapNode *preorder(const Treap& other); //copy constructor helper function. 
} ;
